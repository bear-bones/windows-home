...
" by default start with captialization
call Abbrev()


" ex commands to toggle capitalization mode
command! AutoCap call Abbrev()
command! NoAutoCap call Unabbrev()


" begin single-quote/double-quote/comment and disable casing
inoremap ``` <esc>:call Unabbrev()<cr>a'
nnoremap ```      :call Unabbrev()<cr>a'
inoremap ~~~ <esc>:call Unabbrev()<cr>a"
nnoremap ~~~      :call Unabbrev()<cr>a"
inoremap /// <esc>:call Unabbrev()<cr>a/*<space>
nnoremap ///      :call Unabbrev()<cr>a/*<space>

" end single-quote/double-quote/comment and re-enable casing
inoremap ''' <esc>:call Abbrev()<cr>a'
nnoremap '''      :call Abbrev()<cr>a'
inoremap """ <esc>:call Abbrev()<cr>a"
nnoremap """      :call Abbrev()<cr>a"
inoremap \\\ <esc>:call Abbrev()<cr>a<space>*/
nnoremap \\\      :call Abbrev()<cr>a<space>*/


" change case of previous word
inoremap <c-u> <esc>mzbveU`za
nnoremap <c-u>      mzbveU`z
inoremap <c-l> <esc>mzbveu`za
nnoremap <c-l>      mzbveu`z
