...
nnoremap <silent> <buffer> <leader>iopdai iDEF INPUT-OUTPUT PARAM AS DATE NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
inoremap <silent> <buffer> <leader>iopdei DEF INPUT-OUTPUT PARAM AS DEC NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
nnoremap <silent> <buffer> <leader>iopdei iDEF INPUT-OUTPUT PARAM AS DEC NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
inoremap <silent> <buffer> <leader>iophai DEF INPUT-OUTPUT PARAM AS HANDLE NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
nnoremap <silent> <buffer> <leader>iophai iDEF INPUT-OUTPUT PARAM AS HANDLE NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
inoremap <silent> <buffer> <leader>iopini DEF INPUT-OUTPUT PARAM AS INT NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
nnoremap <silent> <buffer> <leader>iopini iDEF INPUT-OUTPUT PARAM AS INT NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
inoremap <silent> <buffer> <leader>ioploi DEF INPUT-OUTPUT PARAM AS LOG NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
nnoremap <silent> <buffer> <leader>ioploi iDEF INPUT-OUTPUT PARAM AS LOG NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
inoremap <silent> <buffer> <leader>ioproi DEF INPUT-OUTPUT PARAM AS ROWID NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
nnoremap <silent> <buffer> <leader>ioproi iDEF INPUT-OUTPUT PARAM AS ROWID NO-UNDO INIT .<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
" }}}
...
inoremap <silent> <buffer> <leader>proc <esc>:Procedure<cr>
nnoremap <silent> <buffer> <leader>proc      :Procedure<cr>

command! -nargs=? Procedure call Proc(<f-args>)
...
inoremap <silent> <buffer> <leader>func <esc>:Function<cr>
nnoremap <silent> <buffer> <leader>func      :Function<cr>

command! -nargs=? Function call Func(<f-args>)
